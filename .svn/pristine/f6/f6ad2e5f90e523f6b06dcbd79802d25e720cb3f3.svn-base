<%
   ...
   * 작성자     : 한준희
   * 상세설명  : 화면의 footer 부분
   		          필요한 script를 적거나 커스텀js 파일 링크 적는부분
   		           젤 먼저 읽어야할 script를 맨위에 써야함.
   * 화면ID  :
   * ================================================================= 
   * 수정일         작성자             내용      
   * ----------------------------------------------------------------------- 
...
<footer class="container-fluid footer text-dark w-100">
    <div class="container">
        <div class="row g-4 align-items-center">
            ...
            <div class="col-md-6 text-center text-md-end">This platform was developed by Junhee Han, Minho Kang, Yoona Kim, Jeongin Kim, Youngbeom Jeon, and Dohyeon Jeong.</div>
        </div>
...
<div class="mobile-footer">
    <div class="icon-row">
        ...
        <a href="/" class="footer-icon-link" aria-label="채팅">
            <span class="footer-icon-placeholder"><i class="fas fa-comments"></i></span>
        </a>
        <a href="/" class="footer-icon-link" aria-label="게시판">
            <span class="footer-icon-placeholder"><i class="fas fa-th-list"></i></span>
        </a>
        <a href="/" class="footer-icon-link" aria-label="팁">
            <span class="footer-icon-placeholder"><i class="fas fa-lightbulb"></i></span>
        </a>
        <a href="/" class="footer-icon-link" aria-label="마이페이지">
