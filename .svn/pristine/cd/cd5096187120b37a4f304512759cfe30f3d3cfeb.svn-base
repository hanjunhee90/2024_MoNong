...
<div class="mobile-header d-md-none">
    <header class="d-flex align-items-center justify-content-between px-3 py-2">
        <div>
            <c:if test="${empty userInfo}">
                <a href="/auth/loginView" class="text-light text-decoration-none">로그인</a>
            </c:if>

			<c:if test="${not empty userInfo}">
				<span class="text-light">${userInfo.memNic}님</span>
            ...
            <ul class="navbar-nav">
	            ...
	            <li class="nav-item">
	                <a class="nav-link" href="/mypage/main">
	                	<img src="/static/assets/img/back.png" alt="" style="width:20px; height:20px;">  마이페이지
	                </a>
	            </li>
	            <li class="nav-item">
