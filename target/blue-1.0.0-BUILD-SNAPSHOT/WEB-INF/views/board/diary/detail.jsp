...
<body>
    ...
    window.onload = function() {
        setTimeout(function() {  // 1초 지연 후 실행
            ...
            console.log("Diary writer ID:", diaryWriterId);  // 확인용 로그
            ...
            if (userSub && userSub === diaryWriterId) {
                ...
                console.log("User is the writer. Showing edit button.");
            }
